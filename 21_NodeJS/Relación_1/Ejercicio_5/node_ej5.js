...
var mostrar_hello_world = (peticion, resultado) => {
    ...
    resultado.write("Camino completo del recurso y parámetros:"+peticion.url+"<br>");
    resultado.write("Sólo el camino y nombre del rescurso: "+url_pagina.pathname+"<br>");
    resultado.write("Parámetros del recurso: "+ url_pagina.query+"<br>");
